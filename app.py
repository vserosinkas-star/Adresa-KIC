...
def get_backup_data():
    """Резервные данные с БОЛЬШИМ количеством примеров"""
    backup_data = [
        {
        ...
        {
            'locality': 'Октябрьская',
            'type': 'Станица',
            'kic': 'ДО №8598/0497 КИЦ Краснодар',
            'address': '350000, г. Краснодар, ул. Красная, 1',
            'fio': 'Ковалев Дмитрий Иванович',
            'phone': '999-666-7788',
            'email': 'kovalev@example.ru'
        },
        {
            'locality': 'Октябрьское Поле',
            'type': 'Микрорайон',
            'kic': 'ДО №8598/0498 КИЦ Москва',
            'address': '125190, г. Москва, ул. Народного Ополчения, 34',
        ...
        },
        {
            'locality': 'Октябрь',
            'type': 'Село',
            'kic': 'ДО №8598/0499 КИЦ Оренбург',
            'address': '460000, г. Оренбург, ул. Советская, 20',
            'fio': 'Орлов Олег Олегович',
            'phone': '999-888-9900',
            'email': 'orlov@example.ru'
        },
        {
            'locality': 'Октябрьский',
            'type': 'Рабочий поселок',
            'kic': 'ДО №8598/0500 КИЦ Пермь',
            'address': '614000, г. Пермь, ул. Ленина, 58',
            'fio': 'Павлов Павел Павлович',
            'phone': '999-999-0011',
            'email': 'pavlov@example.ru'
        },
        {
            'locality': 'Октябрьское',
            'type': 'Слобода',
            'kic': 'ДО №8598/0501 КИЦ Ростов',
            'address': '344000, г. Ростов-на-Дону, ул. Большая Садовая, 70',
            'fio': 'Романов Роман Романович',
            'phone': '999-001-1122',
            'email': 'romanov@example.ru'
        },
        {
            'locality': 'Октябрь',
            'type': 'Хутор',
            'kic': 'ДО №8598/0502 КИЦ Ставрополь',
            'address': '355000, г. Ставрополь, пр-т Карла Маркса, 94',
            'fio': 'Сергеев Сергей Сергеевич',
            'phone': '999-112-2233',
            'email': 'sergeev@example.ru'
        },
        {
            'locality': 'Октябрьский',
            'type': 'Городской округ',
            'kic': 'ДО №8598/0503 КИЦ Тюмень',
            'address': '625000, г. Тюмень, ул. Республики, 55',
            'fio': 'Тихонов Тихон Тихонович',
            'phone': '999-223-3344',
            'email': 'tikhonov@example.ru'
        },
        {
            'locality': 'Октябрьское',
            'type': 'Муниципальное образование',
            'kic': 'ДО №8598/0504 КИЦ Уфа',
            'address': '450000, г. Уфа, ул. Ленина, 27',
            'fio': 'Уваров Увар Уварович',
            'phone': '999-334-4455',
            'email': 'uvarov@example.ru'
        },
        {
            'locality': 'Октябрь',
            'type': 'Аул',
            'kic': 'ДО №8598/0505 КИЦ Махачкала',
            'address': '367000, г. Махачкала, ул. Даниялова, 32',
        ...
        {
            'locality': 'Октябрьский',
            'type': 'Курортный поселок',
            'kic': 'ДО №8598/0506 КИЦ Сочи',
            'address': '354000, г. Сочи, ул. Навагинская, 16',
            'fio': 'Харитонов Харитон Харитонович',
            'phone': '999-556-6677',
            'email': 'kharitonov@example.ru'
        },
        {
            'locality': 'Октябрьское',
            'type': 'Кишлак',
            'kic': 'ДО №8598/0507 КИЦ Ташкент',
            'address': '100000, г. Ташкент, ул. Амира Тимура, 108',
            'fio': 'Цветков Цветан Цветанович',
            'phone': '999-667-7788',
            'email': 'tsvetkov@example.ru'
        },
        {
            'locality': 'Октябрь',
            'type': 'Аул',
            'kic': 'ДО №8598/0508 КИЦ Грозный',
            'address': '364000, г. Грозный, пр-т Ахмата Кадырова, 12',
            'fio': 'Чернов Черныш Чернышевич',
            'phone': '999-778-8899',
            'email': 'chernov@example.ru'
        }
    ]
    return backup_data
