    ...
    try:
        ...
        if 'message' in update:
            ...
            if text == '/start':
                ...
                if all_records:
                    response_text = f"✅ Данные успешно обновлены из базы знаний\n\nЗагружено {len(all_records)} записей."
                else:
                    response_text = "❌ Не удалось загрузить данные из базы знаний. Проверьте доступ к таблице."
